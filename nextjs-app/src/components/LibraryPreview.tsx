...
const LibraryPreview: React.FC<LibraryPreviewProps> = ({ words, datasetName, onBack }) => {
  ...
  return (
    <div className="fixed inset-0 bg-softBg dark:bg-darkBg flex flex-col animate-fade-in z-50 overflow-hidden transition-colors">
      <header className="p-8 bg-white dark:bg-darkSurface border-b border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-200/10 dark:shadow-none flex flex-col gap-6 shrink-0 transition-colors">
